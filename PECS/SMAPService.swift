...
class SMAPService: NSObject, WebSocketDelegate {
    ...
    override init() {
        ...
        socket.connect()
        socket.writeString("uuid = \"a99daf41-f3b3-51a7-97bf-48fb3e7bf130\" or uuid = \"33ecc20c-e636-58eb-863f-142717105075\" or uuid = \"b7ef2e98-2e0a-515b-b534-69894fdddf6f\" or uuid = \"27e1e889-b749-5cf9-8f90-5cc5f1750ddf\"")
    }
    ...
    func websocketDidReceiveMessage(ws: WebSocket, text: String) {
        ...
        if uuid == "a99daf41-f3b3-51a7-97bf-48fb3e7bf130" {
            self.heaterBottom = value.intValue
        } else if uuid == "33ecc20c-e636-58eb-863f-142717105075" {
            self.heaterBack = value.intValue
        } else if uuid == "b7ef2e98-2e0a-515b-b534-69894fdddf6f" {
            self.fanBottom = value.intValue
        } else if uuid == "27e1e889-b749-5cf9-8f90-5cc5f1750ddf" {
            self.fanBack = value.intValue
        }
        NSNotificationCenter.defaultCenter().postNotificationName("kChairStateUpdate", object: nil);
    }
